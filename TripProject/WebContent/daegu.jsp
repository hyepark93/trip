...
.tainfo>div:nth-child(2){
    margin-bottom: 20px;
}
.tainfo>div:nth-child(3){
    width: 250px;
    height: 200px;
    overflow: hidden;
    margin: 0 auto;
}
.tainfo>div:nth-child(3)>img{
    margin: 0 auto;
}
.tainfo>div:nth-child(4){
    font-weight: 600;
    font-size: 20px;
}
.tainfo>div:nth-child(5){
    font-size: 12px;
}
	...
	<div class="search">
		...
		<div style="cursor: pointer">검색</div>
            ...
            <div class="map">
                ...
                <div class="tamap">
                    <img src="img/tamap.png" alt="">
                    <% for(int i=0;i<v.size();i++){  %>
                    
                    <div class="daegu" style="left:<%= v.get(i).getLeftx() %>; top:<%= v.get(i).getTopy() %>;
                    color:green;">
                    <i class="fas fa-circle"></i><div><%= v.get(i).getNAME() %></div></div>
                    <div class="tainfo">
            			<button class="tainfo_close">닫기</button>
            			<div>
...
<%}%>
    ...
    $(".cs").click(function(){
    	...
    	$(".daegu").click(function(){
    		var index = $( ".daegu" ).index( this );
    		$(".modal").fadeIn(300,function(){$(".tainfo").eq(index).fadeIn(500);});
       	 	$(".tainfo").eq(index).draggable();
    	});
    	
    	$(".tainfo_close").click(function(){
            $(".tainfo").fadeOut(300,function(){$(".modal").fadeOut(300)});
        });
    </script>

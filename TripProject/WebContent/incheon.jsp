...
.whole {
	...
	border: 1px solid gray;
        ...
        .ininfo>div:nth-child(2){
        	margin-bottom: 20px;
        }
        .ininfo>div:nth-child(3){
             width: 250px;
             height: 200px;
             overflow: hidden;
             margin: 0 auto;
        }
        .ininfo>div:nth-child(3)>img{
        	margin: 0 auto;
        }
        .ininfo>div:nth-child(4){
        	font-weight: 600;
        	font-size: 20px;
        }
        .ininfo>div:nth-child(5){
        	font-size: 12px;
        }
	...
	<div class="search">
		...
		<div style="cursor: pointer">검색</div>
            ...
            <div class="map">
                ...
                <div class="inmap">
                    <img src="files/inmap.png" alt="">
                    <% for(int i=0;i<v.size();i++){  %>
                    
                    <div class="incheon" style="left:<%= v.get(i).getLeftx() %>; top:<%= v.get(i).getTopy() %>;
                    color:crimson;">
                    <i class="fas fa-circle"></i><div><%= v.get(i).getNAME() %></div></div>
                    <div class="ininfo">
            			<button class="ininfo_close">닫기</button>
            			<div>
...
<%}%>
    ...
    $(".cs").click(function(){
    	...
    	$(".incheon").click(function(){
    		var index = $( ".incheon" ).index( this );
    		$(".modal").fadeIn(300,function(){$(".ininfo").eq(index).fadeIn(500);});
       	 	$(".ininfo").eq(index).draggable();
    	});
    	
    	$(".ininfo_close").click(function(){
            $(".ininfo").fadeOut(300,function(){$(".modal").fadeOut(300)});
        });
    </script>

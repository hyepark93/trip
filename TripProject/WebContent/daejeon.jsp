...
.whole {
	...
	border: 1px solid gray;
        ...
        .dainfo>div:nth-child(2){
        	margin-bottom: 20px;
        }
        .dainfo>div:nth-child(3){
             width: 250px;
             height: 200px;
             overflow: hidden;
             margin: 0 auto;
        }
        .dainfo>div:nth-child(3)>img{
        	margin: 0 auto;
        }
        .dainfo>div:nth-child(4){
        	font-weight: 600;
        	font-size: 20px;
        }
        .dainfo>div:nth-child(5){
        	font-size: 12px;
        }
	...
	<div class="search">
		...
		<div style="cursor: pointer">검색</div>
            ...
            <div class="map">
                ...
                <div class="damap">
                    <img src="files/damap.png" alt="">
                    <% for(int i=0;i<v.size();i++){  %>
                    
                    <div class="daejeon" style="left:<%= v.get(i).getLeftx() %>; top:<%= v.get(i).getTopy() %>;
                    color:fuchsia;">
                    <i class="fas fa-circle"></i><div><%= v.get(i).getNAME() %></div></div>
                    <div class="dainfo">
            			<button class="dainfo_close">닫기</button>
            			<div>
...
<%}%>
    ...
    $(".cs").click(function(){
    	...
    	$(".daejeon").click(function(){
    		var index = $( ".daejeon" ).index( this );
    		$(".modal").fadeIn(300,function(){$(".dainfo").eq(index).fadeIn(500);});
       	 	$(".dainfo").eq(index).draggable();
    	});
    	
    	$(".dainfo_close").click(function(){
            $(".dainfo").fadeOut(300,function(){$(".modal").fadeOut(300)});
        });
    </script>

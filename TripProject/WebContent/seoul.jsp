...
.whole {
	...
	border: 1px solid gray;
        ...
        .seinfo>div:nth-child(2){
        	margin-bottom: 20px;
        }
        .seinfo>div:nth-child(3){
             width: 250px;
             height: 200px;
             overflow: hidden;
             margin: 0 auto;
        }
        .seinfo>div:nth-child(3)>img{
        	margin: 0 auto;
        }
        .seinfo>div:nth-child(4){
        	font-weight: 600;
        	font-size: 20px;
        }
        .seinfo>div:nth-child(5){
        	font-size: 12px;
        }
.modal {
	position: fixed;
	...
	<div class="search">
		...
		<div style="cursor: pointer">검색</div>
            ...
            <div class="map">
                ...
                <div class="semap">
                    <img src="files/semap.png" alt="">
                    <% for(int i=0;i<v.size();i++){  %>
                    
                    <div class="seoul" style="left:<%= v.get(i).getLeftx() %>; top:<%= v.get(i).getTopy() %>;
                    color:blue;">
                    <i class="fas fa-circle"></i><div><%= v.get(i).getNAME() %></div></div>
                    <div class="seinfo">
            			<button class="seinfo_close">닫기</button>
            			<div>
...
<%}%>
    ...
    $(".cs").click(function(){
    	...
    	$(".seoul").click(function(){
    		var index = $( ".seoul" ).index( this );
    		$(".modal").fadeIn(300,function(){$(".seinfo").eq(index).fadeIn(500);});
       	 	$(".seinfo").eq(index).draggable();
    	});
    	
    	$(".seinfo_close").click(function(){
            $(".seinfo").fadeOut(300,function(){$(".modal").fadeOut(300)});
        });
    </script>
</body>
</html>
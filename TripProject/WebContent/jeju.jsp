...
.whole {
	...
	border: 1px solid gray;
        ...
        .jeinfo>div:nth-child(2){
        	margin-bottom: 20px;
        }
        .jeinfo>div:nth-child(3){
             width: 250px;
             height: 200px;
             overflow: hidden;
             margin: 0 auto;
        }
        .jeinfo>div:nth-child(3)>img{
        	margin: 0 auto;
        }
        .jeinfo>div:nth-child(4){
        	font-weight: 600;
        	font-size: 20px;
        }
        .jeinfo>div:nth-child(5){
        	font-size: 12px;
        }
.modal {
	position: fixed;
	...
	<div class="search">
		...
		<div style="cursor: pointer">검색</div>
            ...
            <div class="map">
                ...
                <div class="jemap">
                    <img src="img/jemap.png" alt="">
                    <% for(int i=0;i<v.size();i++){  %>
                    
                    <div class="jeju" style="left:<%= v.get(i).getLeftx() %>; top:<%= v.get(i).getTopy() %>;
                    color:blueviolet;">
                    <i class="fas fa-circle"></i><div><%= v.get(i).getNAME() %></div></div>
                    <div class="jeinfo">
            			<button class="jeinfo_close">닫기</button>
            			<div><span><%= v.get(i).getRegion() %></span> > <span><%= v.get(i).getGrouping() %></span></div>
            			<div><img src="img/<%= v.get(i).getImg() %>" alt=""></div>
...
<%}%>
    ...
    $(".cs").click(function(){
    	...
    	$(".jeju").click(function(){
    		var index = $( ".jeju" ).index( this );
    		$(".modal").fadeIn(300,function(){$(".jeinfo").eq(index).fadeIn(500);});
       	 	$(".jeinfo").eq(index).draggable();
    	});
    	
    	$(".jeinfo_close").click(function(){
            $(".jeinfo").fadeOut(300,function(){$(".modal").fadeOut(300)});
        });
    </script>

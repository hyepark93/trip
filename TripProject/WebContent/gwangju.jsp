...
.whole {
	...
	border: 1px solid gray;
        ...
        .gwinfo>div:nth-child(2){
        	margin-bottom: 20px;
        }
        .gwinfo>div:nth-child(3){
             width: 250px;
             height: 200px;
             overflow: hidden;
             margin: 0 auto;
        }
        .gwinfo>div:nth-child(3)>img{
        	margin: 0 auto;
        }
        .gwinfo>div:nth-child(4){
        	font-weight: 600;
        	font-size: 20px;
        }
        .gwinfo>div:nth-child(5){
        	font-size: 12px;
        }
	...
	<div class="search">
		...
		<div style="cursor: pointer">검색</div>
            ...
            <div class="map">
                ...
                <div class="gwmap">
                    <img src="files/gwmap.png" alt="">
                    <% for(int i=0;i<v.size();i++){  %>
                    
                    <div class="gwangju" style="left:<%= v.get(i).getLeftx() %>; top:<%= v.get(i).getTopy() %>;
                    color:gold;">
                    <i class="fas fa-circle"></i><div><%= v.get(i).getNAME() %></div></div>
                    <div class="gwinfo">
            			<button class="gwinfo_close">닫기</button>
            			<div>
...
<%}%>
    ...
    $(".cs").click(function(){
    	...
    	$(".gwangju").click(function(){
    		var index = $( ".gwangju" ).index( this );
    		$(".modal").fadeIn(300,function(){$(".gwinfo").eq(index).fadeIn(500);});
       	 	$(".gwinfo").eq(index).draggable();
    	});
    	
    	$(".gwinfo_close").click(function(){
            $(".gwinfo").fadeOut(300,function(){$(".modal").fadeOut(300)});
        });
    </script>
